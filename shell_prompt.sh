...
function __promptline_ps1 {
  ...
  [ $is_prompt_empty -eq 1 ] && slice_prefix="$slice_empty_prefix"
  # section "z" slices
  __promptline_wrapper "%n@%m" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; is_prompt_empty=0; }
...
function __promptline_right_prompt {
  ...
  # section "z" slices
  __promptline_wrapper "%n@%m" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; }
...
function __promptline {
  ...
  local warn_fg="${wrap}38;5;253${end_wrap}"
  local warn_bg="${wrap}48;5;58${end_wrap}"
  local warn_sep_fg="${wrap}38;5;58${end_wrap}"
  local y_fg="${wrap}38;5;117${end_wrap}"
  local y_bg="${wrap}48;5;235${end_wrap}"
  local y_sep_fg="${wrap}38;5;235${end_wrap}"
  local z_fg="${wrap}38;5;237${end_wrap}"
